...
public partial class DbventaContext : DbContext
{
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        ...
        {
            entity.HasKey(e => e.IdCategoria).HasName("PK__Categori__8A3D240CFE1DCF8B");
        ...
        {
            entity.HasKey(e => e.IdDetalleVenta).HasName("PK__DetalleV__BFE2843F21A6F087");
        ...
        {
            entity.HasKey(e => e.IdMenu).HasName("PK__Menu__C26AF48376DAE1E9");
        ...
        {
            entity.HasKey(e => e.IdMenuRol).HasName("PK__MenuRol__9D6D61A45DD0EA74");
        ...
        {
            entity.HasKey(e => e.IdNumeroDocumento).HasName("PK__NumeroDo__471E421AD3D8DA67");
        ...
        {
            entity.HasKey(e => e.IdProducto).HasName("PK__Producto__07F4A132EF49060B");
        ...
        {
            entity.HasKey(e => e.IdRol).HasName("PK__Rol__3C872F76DE49E0C9");
        ...
        {
            entity.HasKey(e => e.IdUsuario).HasName("PK__Usuario__645723A6E3EE7611");
        ...
        {
            entity.HasKey(e => e.IdVenta).HasName("PK__Venta__077D561405529FB9");
